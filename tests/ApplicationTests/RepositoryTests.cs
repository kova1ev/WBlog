...
namespace ApplicationTests
{
    public class MemoryDbContext : DbContext
    {
        ...
        public void Seed()
        {
            if (!Posts.Any())
            {
                Tag code = new() { Id = new Guid("0ac7974e-9451-4c07-a9b8-ac71f1cbf44e"), Name = "Code" };
                Tag cat = new() { Id = new Guid("dfa877de-d705-4978-be65-7fc3ca289611"), Name = "Cat" };
                Tag white = new Tag { Id = new Guid("10115049-61e7-4a3a-9e20-7b6ae65311ec"), Name = "white" };
                Tag android = new Tag { Id = new Guid("cf792e1b-fd60-40e5-b618-1f2a2e4915c5"), Name = "android" };
                Tag black = new Tag { Id = new Guid("93114f4d-8b0e-4dfa-b391-3a79b0d7e2c4"), Name = "black" };
                Tag car = new Tag { Id = new Guid("975c0def-c2a5-4f28-88f1-f81facf4b726"), Name = "car" };
                Tag csharp = new Tag { Id = new Guid("6819ed45-e4f7-43f5-b1ae-0b5a9ab70132"), Name = "CSharp" };
                Tag pro = new Tag { Id = new Guid("4188098d-3d8e-4970-b214-20a350e3049e"), Name = "pro" };
                Tag py = new Tag { Id = new Guid("b0d34bfc-b7e9-4950-a0be-b1c4bf2622b3"), Name = "Py" };
                Tag cpp = new Tag { Id = new Guid("72316442-0a56-4f86-8d14-b85a94d4121d"), Name = "cpp" };
                Tag jizn = new Tag { Id = new Guid("8b0b0b68-56cb-49dd-bd96-e57f2a7d86d9"), Name = "жизнь" };
                Tag phone = new Tag { Id = new Guid("3c534da0-3bca-485d-a48a-9acc79d79aaf"), Name = "phone" };
                Tag samsung = new Tag { Id = new Guid("9a6f54ba-64d1-4879-838d-47b3360ba4ff"), Name = "samsung" };
                Tag valve = new Tag { Id = new Guid("133f8f7f-6105-44b1-980d-683a22abb897"), Name = "valve" };
                Tag blizzard = new Tag { Id = new Guid("7c6ab66c-fc98-46c1-a367-ee093aa26544"), Name = "blizzard" };
